...
namespace vm
{
    ...
    static Il2CppMethodPointer GetReversePInvokeWrapperFromIndex(MonoMethod* method)
    {
        ...
        const Il2CppTokenIndexPair* res = (const Il2CppTokenIndexPair*)bsearch(&key, codeGenModule->reversePInvokeWrapperIndices, codeGenModule->reversePInvokeWrapperCount, sizeof(Il2CppTokenIndexPair), CompareIl2CppTokenIndexPair);
