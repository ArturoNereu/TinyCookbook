...
namespace Threading
{
    ...
    static il2cpp::os::FastMutex m_Atomic64Mutex;
#endif
    ...
    {
        return reinterpret_cast<intptr_t>(il2cpp::os::Atomic::CompareExchangePointer(reinterpret_cast<void*volatile*>(location), reinterpret_cast<void*>(value), reinterpret_cast<void*>(comparand)));
    }
    ...
    {
        return reinterpret_cast<intptr_t>(il2cpp::os::Atomic::ExchangePointer(reinterpret_cast<void*volatile*>(location), reinterpret_cast<void*>(value)));
    }
