...
#ifdef UT_32BIT
namespace Unity { namespace Tiny { namespace Text { 
static_assert(sizeof(NativeFont) == 12, "NativeFont size mismatch");
...
static_assert(offsetof(NativeFont, status) == 8, "NativeFont.status offset mismatch");
}}}
#endif
...
#ifdef UT_32BIT
namespace Unity { namespace Tiny { namespace Text { 
static_assert(sizeof(NativeFontLoading) == 8, "NativeFontLoading size mismatch");
static_assert(offsetof(NativeFontLoading, internalId) == 0, "NativeFontLoading.internalId offset mismatch");
}}}
#endif
...
#ifdef UT_32BIT
namespace Unity { namespace Tiny { namespace Text { 
static_assert(sizeof(NativeFontPrivate) == 4, "NativeFontPrivate size mismatch");
static_assert(offsetof(NativeFontPrivate, fontHandle) == 0, "NativeFontPrivate.fontHandle offset mismatch");
}}}
#endif
...
#ifdef UT_32BIT
namespace Unity { namespace Tiny { namespace Text { 
static_assert(sizeof(NativeFontLoadFromFileName) == 2, "NativeFontLoadFromFileName size mismatch");
static_assert(offsetof(NativeFontLoadFromFileName, c) == 0, "NativeFontLoadFromFileName.c offset mismatch");
}}}
#endif
...
#ifdef UT_32BIT
namespace Unity { namespace Tiny { namespace Text { 
static_assert(sizeof(NativeFontLoadFromFile) == 4, "NativeFontLoadFromFile size mismatch");
static_assert(offsetof(NativeFontLoadFromFile, dummy) == 0, "NativeFontLoadFromFile.dummy offset mismatch");
}}}
#endif
...
DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_16_cid = -1;
...
DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_17_cid = -1;
...
DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_18_cid = -1;
...
DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_19_cid = -1;
