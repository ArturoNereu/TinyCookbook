...
struct NativeFont {
  ...
  Unity::Tiny::Text::FontStatus status;
};
}}}
...
template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::NativeFont>()
{
    if (priv_bind_Unity_Tiny_Text_12_cid == -1) {
        priv_bind_Unity_Tiny_Text_12_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(7113612759256978488ull);
    }
    return priv_bind_Unity_Tiny_Text_12_cid;
}

namespace Unity { namespace Tiny { namespace Text { 
struct NativeFontLoading : Unity::Entities::ISystemStateComponentData {
  int64_t internalId;
};
}}}
...
template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::NativeFontLoading>() {
    return priv_bind_Unity_Tiny_Text_13_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::NativeFontLoading>()
{
    if (priv_bind_Unity_Tiny_Text_13_cid == -1) {
        priv_bind_Unity_Tiny_Text_13_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(3637771152248580079ull);
    }
    return priv_bind_Unity_Tiny_Text_13_cid;
}

namespace Unity { namespace Tiny { namespace Text { 
struct NativeFontPrivate : Unity::Entities::ISystemStateComponentData {
  int32_t fontHandle;
};
}}}
...
template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::NativeFontPrivate>() {
    return priv_bind_Unity_Tiny_Text_14_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::NativeFontPrivate>()
{
    if (priv_bind_Unity_Tiny_Text_14_cid == -1) {
        priv_bind_Unity_Tiny_Text_14_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(928337035899146015ull);
    }
    return priv_bind_Unity_Tiny_Text_14_cid;
}

namespace Unity { namespace Tiny { namespace Text { 
struct NativeFontLoadFromFileName : Unity::Entities::IBufferElementData {
  uint16_t c;
};
}}}
...
template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::NativeFontLoadFromFileName>() {
    return priv_bind_Unity_Tiny_Text_15_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::NativeFontLoadFromFileName>()
{
    if (priv_bind_Unity_Tiny_Text_15_cid == -1) {
        priv_bind_Unity_Tiny_Text_15_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(13489033180070408049ull);
    }
    return priv_bind_Unity_Tiny_Text_15_cid;
}

namespace Unity { namespace Tiny { namespace Text { 
struct NativeFontLoadFromFile {
  int32_t dummy;
};
}}}

#if !defined(BUILD_UNITY_TINY_TEXT_DLL)
    extern DLLIMPORT ComponentTypeId priv_bind_Unity_Tiny_Text_16_cid;
#else
    extern DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_16_cid;
#endif

template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::NativeFontLoadFromFile>() {
    return priv_bind_Unity_Tiny_Text_16_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::NativeFontLoadFromFile>()
{
    if (priv_bind_Unity_Tiny_Text_16_cid == -1) {
        priv_bind_Unity_Tiny_Text_16_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(12172456334526477340ull);
    }
    return priv_bind_Unity_Tiny_Text_16_cid;
}
...
#if !defined(BUILD_UNITY_TINY_TEXT_DLL)
    extern DLLIMPORT ComponentTypeId priv_bind_Unity_Tiny_Text_17_cid;
#else
    extern DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_17_cid;
#endif

template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::BitmapFont>() {
    return priv_bind_Unity_Tiny_Text_17_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::BitmapFont>()
{
    if (priv_bind_Unity_Tiny_Text_17_cid == -1) {
        priv_bind_Unity_Tiny_Text_17_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(10866330436665620479ull);
    }
    return priv_bind_Unity_Tiny_Text_17_cid;
}
...
#if !defined(BUILD_UNITY_TINY_TEXT_DLL)
    extern DLLIMPORT ComponentTypeId priv_bind_Unity_Tiny_Text_18_cid;
#else
    extern DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_18_cid;
#endif

template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::CharacterInfoBuffer>() {
    return priv_bind_Unity_Tiny_Text_18_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::CharacterInfoBuffer>()
{
    if (priv_bind_Unity_Tiny_Text_18_cid == -1) {
        priv_bind_Unity_Tiny_Text_18_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(15402236120158511343ull);
    }
    return priv_bind_Unity_Tiny_Text_18_cid;
}
...
#if !defined(BUILD_UNITY_TINY_TEXT_DLL)
    extern DLLIMPORT ComponentTypeId priv_bind_Unity_Tiny_Text_19_cid;
#else
    extern DLLEXPORT ComponentTypeId priv_bind_Unity_Tiny_Text_19_cid;
#endif

template<> inline ComponentTypeId ComponentId<::Unity::Tiny::Text::GlyphPrivateBuffer>() {
    return priv_bind_Unity_Tiny_Text_19_cid;
}

template<> inline ComponentTypeId InitComponentId<::Unity::Tiny::Text::GlyphPrivateBuffer>()
{
    if (priv_bind_Unity_Tiny_Text_19_cid == -1) {
        priv_bind_Unity_Tiny_Text_19_cid = Unity::Entities::TypeManager::TypeIndexForStableTypeHash(9172232493986285135ull);
    }
    return priv_bind_Unity_Tiny_Text_19_cid;
}
