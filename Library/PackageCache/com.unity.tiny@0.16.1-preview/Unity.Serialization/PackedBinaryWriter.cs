...
{
    internal class PackedBinaryWriter : IDisposable
    {
        private struct WriteTokensJobOutput
        {
        ...
        private unsafe struct WriteTokensJob : IJob
        {
            ...
            /// </summary>
            private static bool IsObjectKey(Token* tokens, int index)
            {
        ...
        [BurstCompile(CompileSynchronously = true)]
        private unsafe struct WriteCharactersJob : IJobParallelFor
        {
            ...
            private void Write<T>(ref int position, T value) where T : unmanaged
            {
        ...
        private PackedBinaryStream m_Stream;
        private readonly ITokenizer m_Tokenizer;

        private int m_InputTokenNextIndex;
        private int m_InputTokenParentIndex;
