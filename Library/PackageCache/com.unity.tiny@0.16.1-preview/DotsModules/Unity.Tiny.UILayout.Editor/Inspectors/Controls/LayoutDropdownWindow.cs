...
namespace Unity.Editor
{
    internal class LayoutDropdownWindow : PopupWindowContent
    {
        ...
        #region Fields
        private Unity.Tiny.UILayout.RectTransform m_Main;
        ...
        private List<Unity.Tiny.UILayout.RectTransform> RectTransforms { get; }
        #endregion
            ...
            )
        {
            for (var i = 0; i < RectTransforms.Count; ++i)
            {
                ...
                {
                    RectTransformInspector.SetPivotSmart(entity, ref rt, k_PivotsForModes[(int)layoutMode], axis, true);
                }
                ...
                {
                    case LayoutMode.Min:
                        RectTransformInspector.SetAnchorSmart(entity, ref rt, 0, axis, false, true, true);
                        RectTransformInspector.SetAnchorSmart(entity, ref rt, 0, axis, true, true, true);
                        refPosition = rt.offsetMin;
                        break;
                    case LayoutMode.Middle:
                        RectTransformInspector.SetAnchorSmart(entity, ref rt, 0.5f, axis, false, true, true);
                        RectTransformInspector.SetAnchorSmart(entity, ref rt, 0.5f, axis, true, true, true);
                        refPosition = (rt.offsetMin + rt.offsetMax) * 0.5f;
                        break;
                    case LayoutMode.Max:
                        RectTransformInspector.SetAnchorSmart(entity, ref rt, 1, axis, false, true, true);
                        RectTransformInspector.SetAnchorSmart(entity, ref rt, 1, axis, true, true, true);
                ...
                RectTransforms[i] = rt;
                EntityManager.SetComponentData<RectTransform>(entity, rt);
            }
        }
