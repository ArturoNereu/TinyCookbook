...
inline void TransformPoint3NATIVE(const Simd128& m0, const Simd128& m1, const Simd128& m2, const Simd128& m3, const Simd128& vin, Simd128& vout)
{
...
inline void TransformVector3NATIVE(const Simd128& m0, const Simd128& m1, const Simd128& m2, const Simd128& m3, const Simd128& vin, Simd128& vout)
{
	const Simd128 v0 = V4Splat(vin, 0);
	const Simd128 v1 = V4Splat(vin, 1);
	const Simd128 v2 = V4Splat(vin, 2);
...
inline void TransposeMatrix4x4 (const Matrix4x4f* __restrict lhs, Matrix4x4f* __restrict res)
{
