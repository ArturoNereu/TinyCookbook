...
namespace Unity.Editor
{
    internal abstract class SceneGraphBase : ISceneGraph
    {
        ...
        protected virtual void OnInsertNode(ISceneGraphNode node, ISceneGraphNode parent, int siblingIndex)
        {
        }
        ...
        /// <inheritdoc />
        public void Add(IEnumerable<ISceneGraphNode> nodes, ISceneGraphNode parent = null)
        {
        ...
        /// </summary>
        private static int InsertOrAdd<T>(IList<T> list, int index, T item)
        {
            list.Remove(item);
