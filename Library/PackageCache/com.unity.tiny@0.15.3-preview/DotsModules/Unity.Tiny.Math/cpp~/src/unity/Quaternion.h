...
BIND_MANAGED_TYPE_NAME(Quaternionf, UnityEngine_Quaternion);
...
Quaternionf EulerToQuaternion(const Vector3f& euler, math::RotationOrder order = math::kOrderUnityDefault);
...
inline Quaternionf ZRotationToQuaternion(float angle)
{
    Quaternionf q;
