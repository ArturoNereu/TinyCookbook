...
/** An Archetype is a set of component types. When creating multiple entities
    ...
    {@link ut.EntityManager.CreateArchetype} and use that to create multiple entities.*/
class Archetype {
...
declare namespace ut {
    // inside a namespace, imported types have to be re-exported
    export import Vector2 = utmath.Vector2;
    export import Vector3 = utmath.Vector3;
    export import Vector4 = utmath.Vector4;
    export import Quaternion = utmath.Quaternion;
    export import Vector2ComponentFieldDesc = utmath.Vector2ComponentFieldDesc;
    export import Vector3ComponentFieldDesc = utmath.Vector3ComponentFieldDesc;
    export import Vector4ComponentFieldDesc = utmath.Vector4ComponentFieldDesc;
    export import QuaternionComponentFieldDesc = utmath.QuaternionComponentFieldDesc;
    export import Matrix3x3 = utmath.Matrix3;
    export import Matrix4x4 = utmath.Matrix4;
    export import Euler = utmath.Euler;
    export import Plane = utmath.Plane;
}
...
/** Initialize an image from a memory buffer
    Once loading has completed, the asset loading system will remove this component from the image*/
class Image2DLoadFromMemory extends ut.Component {
  constructor(width?: number, height?: number, pixelData?: number[], format?: Image2DMemoryFormat);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DLoadFromMemory): Image2DLoadFromMemory;
  static _toPtr(p: number, v: Image2DLoadFromMemory): void;
  static _tempHeapPtr(v: Image2DLoadFromMemory): number;
  static _dtorFn(v: Image2DLoadFromMemory): void;
}
...
class Image2DSaveToFile extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DSaveToFile): Image2DSaveToFile;
  static _toPtr(p: number, v: Image2DSaveToFile): void;
  static _tempHeapPtr(v: Image2DSaveToFile): number;
  static _dtorFn(v: Image2DSaveToFile): void;
}
...
/** Result of an asynchronous Image2DSaveToFile operation.
    ...
    operation completed.*/
class Image2DSaveToFileResult extends ut.Component {
  constructor(status?: Image2DSaveStatus, imageFile?: string);
  /** The result of the write operation. On success it is Written*/
  status: Image2DSaveStatus;
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DSaveToFileResult): Image2DSaveToFileResult;
  static _toPtr(p: number, v: Image2DSaveToFileResult): void;
  static _tempHeapPtr(v: Image2DSaveToFileResult): number;
  static _dtorFn(v: Image2DSaveToFileResult): void;
}
...
class Image2DSaveToDataURI extends ut.Component {
  constructor();
  static readonly cid: number;
  static readonly _view: any;
  static readonly _isSharedComp: boolean;
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DSaveToDataURI): Image2DSaveToDataURI;
  static _toPtr(p: number, v: Image2DSaveToDataURI): void;
  static _tempHeapPtr(v: Image2DSaveToDataURI): number;
  static _dtorFn(v: Image2DSaveToDataURI): void;
}
...
/** Result of an asynchronous Image2DSaveToDataURI operation.
    ...
    operation completed.*/
class Image2DSaveToDataURIResult extends ut.Component {
  constructor(dataURI?: string, status?: Image2DSaveStatus);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DSaveToDataURIResult): Image2DSaveToDataURIResult;
  static _toPtr(p: number, v: Image2DSaveToDataURIResult): void;
  static _tempHeapPtr(v: Image2DSaveToDataURIResult): number;
  static _dtorFn(v: Image2DSaveToDataURIResult): void;
}
...
class Image2DSaveToMemory extends ut.Component {
  constructor(format?: Image2DMemoryFormat);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DSaveToMemory): Image2DSaveToMemory;
  static _toPtr(p: number, v: Image2DSaveToMemory): void;
  static _tempHeapPtr(v: Image2DSaveToMemory): number;
  static _dtorFn(v: Image2DSaveToMemory): void;
}
...
/** Result of an asynchronous Image2DSaveToMemory operation.
    ...
    operation completed.*/
class Image2DSaveToMemoryResult extends ut.Component {
  constructor(pixelData?: number[], width?: number, height?: number, format?: Image2DMemoryFormat, status?: Image2DSaveStatus);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Image2DSaveToMemoryResult): Image2DSaveToMemoryResult;
  static _toPtr(p: number, v: Image2DSaveToMemoryResult): void;
  static _tempHeapPtr(v: Image2DSaveToMemoryResult): number;
  static _dtorFn(v: Image2DSaveToMemoryResult): void;
}
...
/** Add this component next to a Camera2D to render to a texture instead of to the screen.
    
    To freeze render to texture operation temporarily, at the Disabled component to the camera. 
    It is a lightweight way to temporarily disable render to texture for a camera without de-allocations.*/
class Camera2DRenderToTexture extends ut.Component {
  constructor(width?: number, height?: number, target?: Entity);
...
class TransformService {
  ...
  /** Populates an array with all children of node and Returns
      the number of children added to the children array.
...
class Shape2DVertex extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Shape2DVertex): Shape2DVertex;
  static _toPtr(p: number, v: Shape2DVertex): void;
  static _tempHeapPtr(v: Shape2DVertex): number;
  static _dtorFn(v: Shape2DVertex): void;
}
...
/** Optional: Indices into the vertices of the shape.
    ...
    If there are no indices, vertices are rendered as a triangle fan.*/
class Shape2DIndex extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Shape2DIndex): Shape2DIndex;
  static _toPtr(p: number, v: Shape2DIndex): void;
  static _tempHeapPtr(v: Shape2DIndex): number;
  static _dtorFn(v: Shape2DIndex): void;
}
...
declare namespace ut.Physics2D {
/** Enum that defines how a physics body reacts under physics simulation.*/
enum BodyType {
  /** Static bodies do not move under simulation, and behave as if they had
      infinite mass. They do not collide with other static or kinematic bodies.*/
  Static = 0,
  /** Kinematic bodies are simulated forward according to their velocity,
      but they behave as if they have infinite mass, and do not react
      to forces. Kinematic bodies do not collide with other kinematic bodies,
      or with static bodies.
      To provide behavior for a kinematic body, you can set its position and
      velocity fields while it is simulating.*/
  Kinematic = 1,
  /** Dynamic bodies are fully simulated by physics, and collide with other
      static, kinematic and dynamic bodies.
      Normally you move dynamic bodies using impulses rather than setting their
      velocity or position directly.*/
  Dynamic = 2,
  /** BulletDynamic bodies are like Dynamic bodies, but use continuous collision
      detection when testing collisions against other Dynamic bodies.
      Dynamic bodies always use continuous collision detection against static
      and kinematic bodies, but use discrete collision detection against
      other dynamic bodies for performance reasons.
      
      Set the body type of fast-moving dynamic objects to BulletDynamic to
      have them perform accurate, but more resource-intensive continuous collision
      detection that prevents tunneling.*/
  BulletDynamic = 3,
}
}
declare namespace ut.Physics2D {
...
class Physics2DConfig extends ut.Component {
  constructor(gravity?: Vector2);
  /** Specifies the global gravity vector for the scene in world coordinate space.
      The -Y coordinate represents down in world space, so setting a vector
      such as (0, -10) will produce a downwards force. Set a zero vector to
      disable gravity.*/
  gravity: Vector2;
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Physics2DConfig): Physics2DConfig;
  static _toPtr(p: number, v: Physics2DConfig): void;
  static _tempHeapPtr(v: Physics2DConfig): number;
  static _dtorFn(v: Physics2DConfig): void;
}

}
declare namespace ut.Physics2D {

/** Lists new physics contacts that have occurred during this frame.*/
class NewColliderContacts extends ut.Component {
  constructor(contacts?: Entity[]);
  /** Lists new physics contacts that have occurred during this frame.*/
  contacts: Entity[];
  ...
  static _size: number;
  static _fromPtr(p: number, v?: NewColliderContacts): NewColliderContacts;
  static _toPtr(p: number, v: NewColliderContacts): void;
  static _tempHeapPtr(v: NewColliderContacts): number;
  static _dtorFn(v: NewColliderContacts): void;
}

}
declare namespace ut.Physics2D {

/** Lists existing physics contacts that started during an earlier frame.*/
class ColliderContacts extends ut.Component {
  constructor(contacts?: Entity[]);
  /** Lists existing physics contacts that started during an earlier frame.*/
  contacts: Entity[];
  ...
  static _size: number;
  static _fromPtr(p: number, v?: ColliderContacts): ColliderContacts;
  static _toPtr(p: number, v: ColliderContacts): void;
  static _tempHeapPtr(v: ColliderContacts): number;
  static _dtorFn(v: ColliderContacts): void;
}

}
declare namespace ut.Physics2D {

/** Lists physics contacts that have finished during this frame.*/
class EndedColliderContacts extends ut.Component {
  constructor(contacts?: Entity[]);
  /** Lists physics contacts that have finished during this frame.*/
  contacts: Entity[];
  ...
  static _size: number;
  static _fromPtr(p: number, v?: EndedColliderContacts): EndedColliderContacts;
  static _toPtr(p: number, v: EndedColliderContacts): void;
  static _tempHeapPtr(v: EndedColliderContacts): number;
  static _dtorFn(v: EndedColliderContacts): void;
}
...
class RigidBody2D extends ut.Component {
  constructor(bodyType?: BodyType, freezeRotation?: boolean, friction?: number, restitution?: number, density?: number);
  ...
  /** Specifies the friction factor of this body, when it slides along another
      body.
      Setting friction to 0 creates a frictionless slide, setting it to 1
      creates a strong friction. You can also use values larger than 1.*/
  friction: number;
  /** Specifies the bounciness factor of the object.
      A value of zero means that the object does not bounce when it collides
      with another object (for example, a steel bar). A factor
      of 1 represents a perfect bounce with no loss of energy (for example,
      a superball). You can use values larger than 1.*/
  restitution: number;
  /** Specifies the density of this body.
      The body's mass is computed using the formula: mass = density*volume.*/
  density: number;
  
  static readonly freezeRotation: ComponentFieldDesc;
  static readonly friction: ComponentFieldDesc;
  static readonly restitution: ComponentFieldDesc;
  static readonly density: ComponentFieldDesc;
  static readonly cid: number;
  static readonly _view: any;
  static readonly _isSharedComp: boolean;

  static _size: number;
  static _fromPtr(p: number, v?: RigidBody2D): RigidBody2D;
  static _toPtr(p: number, v: RigidBody2D): void;
  static _tempHeapPtr(v: RigidBody2D): number;
  static _dtorFn(v: RigidBody2D): void;
}

}
declare namespace ut.Physics2D {

/** Adds a circular collision shape to the entity.
    Avoid attaching both a CircleCollider2D and a BoxCollider2D to the same entity.
    If you do, the BoxCollider2D takes precedence and the CircleCollider2D is ignored.*/
class CircleCollider2D extends ut.Component {
  constructor(radius?: number, pivot?: Vector2);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: CircleCollider2D): CircleCollider2D;
  static _toPtr(p: number, v: CircleCollider2D): void;
  static _tempHeapPtr(v: CircleCollider2D): number;
  static _dtorFn(v: CircleCollider2D): void;
}

}
declare namespace ut.Physics2D {

/** Adds a rectangular collision shape to the entity.
    Avoid attaching both a CircleCollider2D and a BoxCollider2D to the same entity.
    If you do, the BoxCollider2D takes precedence and the CircleCollider2D is ignored.*/
class BoxCollider2D extends ut.Component {
  constructor(size?: Vector2, pivot?: Vector2);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: BoxCollider2D): BoxCollider2D;
  static _toPtr(p: number, v: BoxCollider2D): void;
  static _tempHeapPtr(v: BoxCollider2D): number;
  static _dtorFn(v: BoxCollider2D): void;
}

}
declare namespace ut.Physics2D {

/** Add this component to an entity to observe its velocity values during simulation.
    This component is not needed to simulate an entity under physics, but is
    required to access the entity's velocity data.*/
class Velocity2D extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: Velocity2D): Velocity2D;
  static _toPtr(p: number, v: Velocity2D): void;
  static _tempHeapPtr(v: Velocity2D): number;
  static _dtorFn(v: Velocity2D): void;
}

}
declare namespace ut.Physics2D {

/** Add this component to an entity to set its velocity to a custom value.
    After simulation occurs on the next frame, this component is removed from
    the entity automatically.*/
class SetVelocity2D extends ut.Component {
  constructor(velocity?: Vector2);
  ...
  static _size: number;
  static _fromPtr(p: number, v?: SetVelocity2D): SetVelocity2D;
  static _toPtr(p: number, v: SetVelocity2D): void;
  static _tempHeapPtr(v: SetVelocity2D): number;
  static _dtorFn(v: SetVelocity2D): void;
}

}
declare namespace ut.Physics2D {

/** Add this component to an entity to apply a custom impulse on the entity.
    After simulation occurs in the next frame, this component is removed from
    the entity automatically.*/
class AddImpulse2D extends ut.Component {
  constructor(point?: Vector2, impulse?: Vector2, scaleImpulse?: boolean);
  ...
  static readonly point: Vector2ComponentFieldDesc;
  static readonly impulse: Vector2ComponentFieldDesc;
  static readonly scaleImpulse: ComponentFieldDesc;
  static readonly cid: number;
  static readonly _view: any;
  static readonly _isSharedComp: boolean;

  static _size: number;
  static _fromPtr(p: number, v?: AddImpulse2D): AddImpulse2D;
  static _toPtr(p: number, v: AddImpulse2D): void;
  static _tempHeapPtr(v: AddImpulse2D): number;
  static _dtorFn(v: AddImpulse2D): void;
}
...
class Physics2DService {
  /** Returns an entity that occupies the given point in world space, if
      one exists.
      
      The hit test is performed by checking against the physics collision
      shapes (BoxCollider2D and CircleCollider2D) of objects.*/
  static hitTest(w: ut.WorldBase, point: Vector2): Entity;
}
}
declare namespace ut.Physics2D {
/** Performs physics simulations of entities that have RigidBody2D components
    attached to them.*/
var Physics2DSystem: ut.System;
}


declare namespace Module {
function _ut_Physics2D_Physics2DService_HitTest(w: any, point: any): void;
